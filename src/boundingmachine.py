...
def initialize(dim, vdmode=1, vdparams=None, nbridges=0, lfsteps=1, eps=0.0, eta=0.5, mdparams=None,
	...
	params_fixed = (dim, vdmode, nbridges, lfsteps)
...
def compute_ratio(seed, params_flat, unflatten, params_fixed, log_prob):
	...
	dim, vdmode, nbridges, lfsteps = params_fixed
